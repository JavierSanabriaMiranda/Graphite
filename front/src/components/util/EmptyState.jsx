    ...
    <div className="relative flex flex-col items-center justify-center h-full w-full overflow-hidden bg-main-bg">
      ...
      <div className="relative z-10 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-1000 px-6">
        ...
        <button
          ...
          className="cursor-pointer flex items-center gap-2 px-5 py-2.5 bg-zinc-100 dark:bg-zinc-800 text-text-primary hover:bg-zinc-200 dark:hover:bg-zinc-700 text-sm font-medium rounded-xl transition-all border border-zinc-200 dark:border-zinc-700 shadow-sm"
        >
